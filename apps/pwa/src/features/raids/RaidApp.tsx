  ...
  const handoffPanel = allowed.has('handoff-navigator') && !resource.stale && handoffCandidates.length > 0 && (
        <section className="kb-card raid-handoff">
          ...
          <p className="kb-muted">
            Перед передачей дождитесь отправки маршрута со старого телефона. Затем новый навигатор должен открыть этот рейд и разрешить геолокацию. Запись на прежнем телефоне остановится.
          </p>
