...
export default defineConfig({
  ...
  projects: [
    { name: 'chromium', use: { ...devices['Desktop Chrome'] } },
    {
      ...
      testMatch: /(?:browser-photo|field-sync-server|field-retry-navigation|gallery-retention|raid-layout-regressions|result-recovery|user-trust-session|recording-navigation|offline-recovery|rider-motion)\.spec\.ts$/,
    },
  ],
  webServer: [
    {
